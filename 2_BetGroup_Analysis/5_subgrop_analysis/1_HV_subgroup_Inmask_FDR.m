...
%% load files
MaskFile=[PATH,'/2_BetGroup_Analysis/3_GoupLevel_analysis/wGBCr_mww_withCov_mdd_hc_GRF_Vp0001_twotail_mask.nii';
...
%% Statistical analysis: Effects of the Clinical Factors 
for c=1:6
    cov=Cov(ind{c},:);
